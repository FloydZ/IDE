...
IniWrite($MAINOPTFILE, "hWnd", "hMainForm", $hMainForm)
...
IniWrite($MAINOPTFILE, "hWnd", "iFrame_MID_RIGHT", $iFrame_MID_RIGHT)
...
IniWrite($MAINOPTFILE, "hWnd", "iFrame_MID_LEFT", $iFrame_MID_LEFT)
...
IniWrite($MAINOPTFILE, "hWnd", "iFrame_MID_MID", $iFrame_MID_MID)
...
$Form1 = GUICreate("Form1", 398, 186, 539, 354)
$Tab1 = GUICtrlCreateTab(0, 0, 393, 185)
...
Func _DeleteGUIPart()
	For $x = 0 To 3  = @GUI_CtrlId
		If $hDeleteGuiButton[$x] = @GUI_CtrlId then
			Switch $x
				Case 0
					GUIDelete(_GUIFrame_GetHandle($iFrame_MID_RIGHT, 1))
				Case 1
					GUIDelete(_GUIFrame_GetHandle($iFrame_MID_RIGHT, 2))
				Case 2
					GUIDelete(_GUIFrame_GetHandle($iFrame_MID_MID, 1))
				Case 3
					GUIDelete(_GUIFrame_GetHandle($iFrame_MID_MID, 2))
			EndSwitch
