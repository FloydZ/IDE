...
GUISetOnEvent($GUI_EVENT_CLOSE, "_Exit", $OptionsGUI)
...
GUICtrlCreateTabItem("Directions")
	...
	GUICtrlCreateListViewItem("Lib|C:\", $OptionsListview)
	GUICtrlCreateListViewItem("Include|C:\", $OptionsListview)
	GUICtrlCreateListViewItem("Bin|C:\", $OptionsListview)
...
Func _OptionsEditIDEOptions()
	...
	$Text = _GUICtrlListView_GetItemText($Handle, $Mark, 1)
	$Text = FileSelectFolder("Please select a Directions", $Text, 7)
